...
speech_datasets="${DATAROOT}/audio/commonvoice_processed/commonvoice_merged.jsonl"
motion_datasets="/root/pengyang/codebase/SOLAMI/SOLAMI_data/tmp_data/G1ML3D_tokens/motion_train.jsonl"
