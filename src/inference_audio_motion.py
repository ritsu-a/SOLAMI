...
from infer.voice_clone import load_soundstorm, semantic2acoustic
...
class ECModel(nn.Module):
    def __init__(
        ...
        motion_config = open_yaml("/root/pengyang/codebase/SOLAMI/models/vla/motion/motion.yaml")

        self.motion_vae = VQVae(**motion_config)
        state_dict = torch.load("/root/pengyang/codebase/MotionGPT/experiments/mgpt/Instruct_G1ML3D_1/checkpoints/epoch=39.ckpt",
                                map_location="cpu", weights_only=False)["state_dict"]
        
        self.motion_vae.load_state_dict(state_dict, strict=True)
        self.motion_vae.eval()
        self.motion_vae.to(device=self.device)
...
if __name__ == "__main__":
    ...
    model_name_or_path = "/root/pengyang/codebase/SOLAMI/output/pretrain_audio_motion_final/checkpoint-245481"
    output_dir = "/root/pengyang/codebase/SOLAMI/output/inder_audio_motion"
    ...
    motion_tokenizer_dir = "/root/pengyang/codebase/MotionGPT/experiments/mgpt/VQVAE_G1ML3D_1"
